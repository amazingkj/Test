...
<dl class="sub_menu">
<dd><a href="./customerMain.jsp">FAQ</a></dd>
<dd><a href="./onebyoneFnq.jsp">1:1문의</a></dd>
<dd><a href="#">공지사항</a></dd>
<dd><a href="#">환불규정</a></dd>
<dd><a href="./holeInOne.jsp">홀인원보험</a></dd>
<Br>
<br>
</dl>
...
<ul class="consultMemo">
		...
		<li>언제든 궁금하신 점을 남겨주세요. 고객센터 운영시간 내에 확인 후 최대한 빠르고 정확하게 답변
			드리겠습니다.<br> (운영시간 : 오전 9:30 ~ 오후 6:00)
		</li>
...
<dd><input name="question_title" id="question_title" class="textField" placeholder="제목을 입력하세요."><br></dd>

<dt>내용</dt>

<dd><textarea name="question_contents" id="question_contents" class="textField" placeholder="내용을 입력하세요."></textarea></dd>

<dt>파일첨부</dt>

<dd><input type="file" name="question_file" id="question_file" />
<label for="question_file" class="file-upload-button">파일 등록</label>
<span class="file-upload-button-text">*첨부파일 용량은 최대 5Mbyte입니다.</span></dd>

<dt>휴대폰</dt>

<dd><input name="phone01" id="phone01" size="5px"> - <input name="phone02" id="phone02" size="5px"> - <input name="phone03" id="phone03" size="5px"></dd>

<dt>이메일</dt>

<dd><input type="email" name="question_email" id="question_email" class="textField" placeholder="aaa@google.net">
<span>*이메일로 답변을 드립니다.</span></dd>
