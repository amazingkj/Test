...
public class china01_03 extends JFrame{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					china01_03 window = new china01_03();
	...
	private void initialize() {
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				dto.setMeimg_2("./images/hs_ch1_3.png");
		...
		JLabel btn2_3c = new JLabel("New label");
		btn2_3c.setIcon(new ImageIcon("./images/hs_ch1_3.png"));
		btn2_3c.setBounds(12, 0, 448, 203);
		getContentPane().add(btn2_3c);
		...
		btnNewButton_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				String b=Integer.toString(28000*i);
				textField.setText(b);
			}
		});
