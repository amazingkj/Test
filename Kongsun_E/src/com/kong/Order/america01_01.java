...
public class america01_01 extends JFrame{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					america01_01 window = new america01_01();
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	private void initialize() {
		...
		btnNewButton1.setBounds(24, 537, 427, 104);
		getContentPane().add(btnNewButton1);
		btnNewButton1.setBorderPainted(false);
		btnNewButton1.setContentAreaFilled(false);
		btnNewButton1.setFocusPainted(false);
		btnNewButton1.setIcon(new ImageIcon("./images/hs_in1.png"));
		btnNewButton1.setPressedIcon(new ImageIcon("./images/hs_in2.png"));
		btnNewButton1.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent arg0) {
				dto.setMeimg_2("./images/hs_am1_1.png");
		...
		JLabel btn1_1a = new JLabel("New label");
		btn1_1a.setIcon(new ImageIcon("./images/hs_am1_1.png"));
		btn1_1a.setBounds(12, 0, 448, 203);
		getContentPane().add(btn1_1a);
		...
		btnNewButton_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				String b=Integer.toString(4900*i);
				textField.setText(b);
			}
		});
