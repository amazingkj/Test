...
public class japan03_02 extends JFrame{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					japan03_02 window = new japan03_02();
	...
	private void initialize() {
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				dto.setMeimg_2("./images/hs_jp3_2.png");
		...
		JLabel btn3_2j = new JLabel("New label");
		btn3_2j.setIcon(new ImageIcon("./images/hs_jp3_2.png"));
		btn3_2j.setBounds(12, 0, 448, 203);
		getContentPane().add(btn3_2j);
