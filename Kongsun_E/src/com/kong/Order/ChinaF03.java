...
public class ChinaF03 extends JFrame{
	...
	private void initialize() {
		...
		JLabel lblNewLabel = new JLabel("해피 판다");
		...
		btnNewButton.setIcon(new ImageIcon("./images/hs_ch3_1.png"));
		...
		button.setIcon(new ImageIcon("./images/hs_ch3_2.png"));
		...
		button_1.setIcon(new ImageIcon("./images/hs_ch3_3.png"));
