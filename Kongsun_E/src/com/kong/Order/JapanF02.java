...
public class JapanF02 extends JFrame{
	...
	private void initialize() {
		...
		JLabel lblNewLabel = new JLabel("우동마이루식");
		...
		btnNewButton.setIcon(new ImageIcon("./images/hs_jp2_1.png"));
		...
		button.setIcon(new ImageIcon("./images/hs_jp2_2.png"));
		...
		button_1.setIcon(new ImageIcon("./images/hs_jp2_3.png"));
