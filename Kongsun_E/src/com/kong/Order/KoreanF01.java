...
import com.kong.Home.*;

public class KoreanF01 extends JFrame{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					KoreanF01 window = new KoreanF01();
	...
	private void initialize() {
		...
		JLabel lblNewLabel = new JLabel("별사랑 불고기");
		...
		btnNewButton.setIcon(new ImageIcon("./images/hs_ko1_1.png"));
		...
		button.setIcon(new ImageIcon("./images/hs_ko1_2.png"));
		...
		button_1.setIcon(new ImageIcon("./images/hs_ko1_3.png"));
