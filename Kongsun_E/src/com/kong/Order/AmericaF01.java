...
public class AmericaF01 extends JFrame{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AmericaF01 window = new AmericaF01();
	...
	private void initialize() {
		...
		JLabel lblNewLabel = new JLabel("에그드랍");
		...
		btnNewButton.setIcon(new ImageIcon("./images/hs_am1_1.png"));
		...
		button.setIcon(new ImageIcon("./images/hs_am1_2.png"));
		...
		button_1.setIcon(new ImageIcon("./images/hs_am1_3.png"));
