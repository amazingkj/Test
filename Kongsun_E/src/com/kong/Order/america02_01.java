...
public class america02_01 extends JFrame{

	MenuDAO dao = new MenuDAO();
	MenuDTO dto = new MenuDTO();

	public class america02_02 {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					america02_01 window = new america02_01();
	...
	private void initialize() {
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				dto.setMeimg_2("./images/hs_am2_1.png");
		...
		btn1_1a.setIcon(new ImageIcon("./images/hs_am2_1.png"));
		...
		btnNewButton_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				String b=Integer.toString(9900*i);
				textField.setText(b);
			}
		});
