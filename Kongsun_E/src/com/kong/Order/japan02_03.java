...
public class japan02_03 extends JFrame{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					japan02_03 window = new japan02_03();
	...
	private void initialize() {
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				dto.setMeimg_2("./images/hs_jp2_3.png");
		...
		JLabel btn2_3j = new JLabel("New label");
		btn2_3j.setIcon(new ImageIcon("./images/hs_jp2_3.png"));
		btn2_3j.setBounds(12, 0, 448, 203);
		getContentPane().add(btn2_3j);
		...
		btnNewButton_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				String b=Integer.toString(15900*i);
				textField.setText(b);
			}
		});
