...
public class japan01_02 extends JFrame{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					japan01_02 window = new japan01_02();
	...
	private void initialize() {
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				dto.setMeimg_2("./images/hs_jp1_2.png");
		...
		JLabel btn1_2j = new JLabel("New label");
		btn1_2j.setIcon(new ImageIcon("./images/hs_jp1_2.png"));
		btn1_2j.setBounds(12, 0, 448, 203);
		getContentPane().add(btn1_2j);
