...
public class korea02_03 extends JFrame{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					korea02_03 window = new korea02_03();
	...
	private void initialize() {
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				dto.setMeimg_2("./images/hs_ko2_3.png");
		...
		JLabel btn2_3k = new JLabel("New label");
		btn2_3k.setIcon(new ImageIcon("./images/hs_ko2_3.png"));
		btn2_3k.setBounds(12, 0, 448, 203);
		getContentPane().add(btn2_3k);
