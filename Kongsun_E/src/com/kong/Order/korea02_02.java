...
public class korea02_02 extends JFrame{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					korea02_02 window = new korea02_02();
	...
	private void initialize() {
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				dto.setMeimg_2("./images/hs_ko2_2.png");
		...
		JLabel btn2_2k = new JLabel("New label");
		btn2_2k.setIcon(new ImageIcon("./images/hs_ko2_2.png"));
		btn2_2k.setBounds(12, 0, 448, 203);
		getContentPane().add(btn2_2k);
