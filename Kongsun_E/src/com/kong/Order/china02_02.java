...
public class china02_02 extends JFrame{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					china02_02 window = new china02_02();
	...
	private void initialize() {
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				dto.setMeimg_2("./images/hs_ch2_2.png");
		...
		JLabel btn2_2c = new JLabel("New label");
		btn2_2c.setIcon(new ImageIcon("./images/hs_ch2_2.png"));
		btn2_2c.setBounds(12, 0, 448, 203);
		getContentPane().add(btn2_2c);
		...
		btnNewButton_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				String b=Integer.toString(20000*i);
				textField.setText(b);
			}
		});
