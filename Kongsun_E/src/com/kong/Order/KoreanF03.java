...
public class KoreanF03 extends JFrame{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					KoreanF03 window = new KoreanF03();
	...
	private void initialize() {
		...
		JLabel lblNewLabel = new JLabel("지인이네 갈비찜");
		...
		btnNewButton.setIcon(new ImageIcon("./images/hs_ko3_1.png"));
		...
		button.setIcon(new ImageIcon("./images/hs_ko3_2.png"));
		...
		button_1.setIcon(new ImageIcon("./images/hs_ko3_3.png"));
