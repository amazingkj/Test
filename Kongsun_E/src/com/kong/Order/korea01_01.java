...
public class korea01_01 extends JFrame{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					korea01_01 window = new korea01_01();
	...
	private void initialize() {
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				dto.setMeimg_2("./images/hs_ko1_1.png");
		...
		JLabel btn1_1k = new JLabel("New label");
		btn1_1k.setIcon(new ImageIcon("./images/hs_ko1_1.png"));
		btn1_1k.setBounds(12, 0, 448, 203);
		getContentPane().add(btn1_1k);
		...
		btnNewButton_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				String b=Integer.toString(12900*i);
				textField.setText(b);
			}
		});
