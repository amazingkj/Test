...
public class japan03_01 extends JFrame{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					japan03_01 window = new japan03_01();
	...
	private void initialize() {
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				dto.setMeimg_2("./images/hs_jp3_1.png");
		...
		JLabel btn3_1j = new JLabel("New label");
		btn3_1j.setIcon(new ImageIcon("./images/hs_jp3_1.png"));
		btn3_1j.setBounds(12, 0, 448, 203);
		getContentPane().add(btn3_1j);
		...
		btnNewButton_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				String b=Integer.toString(10500*i);
				textField.setText(b);
			}
		});
