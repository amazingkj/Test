...
public class ChinaF01 extends JFrame{
	...
	private void initialize() {
		...
		JLabel lblNewLabel = new JLabel("운봉");
		...
		btnNewButton.setIcon(new ImageIcon("./images/hs_ch1_1.png"));
		...
		button.setIcon(new ImageIcon("./images/hs_ch1_2.png"));
		...
		button_1.setIcon(new ImageIcon("./images/hs_ch1_3.png"));
