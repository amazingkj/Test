...
public class JapanF01 extends JFrame{
	...
	private void initialize() {
		...
		JLabel lblNewLabel = new JLabel("미카코 카레");
		...
		btnNewButton.setIcon(new ImageIcon("./images/hs_jp1_1.png"));
		...
		button.setIcon(new ImageIcon("./images/hs_jp1_2.png"));
		...
		button_1.setIcon(new ImageIcon("./images/hs_jp1_3.png"));
