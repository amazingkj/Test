...
public class america01_02 extends JFrame{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					america01_02 window = new america01_02();
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	private void initialize() {
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				dto.setMeimg_2("./images/hs_am1_2.png");
		...
		JLabel btn1_2a = new JLabel("New label");
		btn1_2a.setIcon(new ImageIcon("./images/hs_am1_2.png"));
		btn1_2a.setBounds(12, 0, 448, 203);
		getContentPane().add(btn1_2a);
		...
		btnNewButton_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				String b=Integer.toString(5600*i);
				textField.setText(b);
			}
		});
