...
public class korea03_02 extends JFrame{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					korea03_02 window = new korea03_02();
	...
	private void initialize() {
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				dto.setMeimg_2("./images/hs_ko3_2.png");
		...
		JLabel btn3_2k = new JLabel("New label");
		btn3_2k.setIcon(new ImageIcon("./images/hs_ko3_2.png"));
		btn3_2k.setBounds(12, 0, 448, 203);
		getContentPane().add(btn3_2k);
		...
		btnNewButton_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				String b=Integer.toString(42000*i);
				textField.setText(b);
			}
		});
