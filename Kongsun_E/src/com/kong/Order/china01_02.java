...
public class china01_02 extends JFrame{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					china01_02 window = new china01_02();
	...
	private void initialize() {
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				dto.setMeimg_2("./images/hs_ch1_2.png");
		...
		JLabel btn1_2c = new JLabel("New label");
		btn1_2c.setIcon(new ImageIcon("./images/hs_ch1_2.png"));
		btn1_2c.setBounds(12, 0, 448, 203);
		getContentPane().add(btn1_2c);
