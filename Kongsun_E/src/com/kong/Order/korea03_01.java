...
public class korea03_01 extends JFrame{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					korea03_01 window = new korea03_01();
	...
	private void initialize() {
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				dto.setMeimg_2("./images/hs_ko3_1.png");
		...
		JLabel btn3_1k = new JLabel("New label");
		btn3_1k.setIcon(new ImageIcon("./images/hs_ko3_1.png"));
		btn3_1k.setBounds(12, 0, 448, 203);
		getContentPane().add(btn3_1k);
		...
		btnNewButton_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				String b=Integer.toString(22000*i);
				textField.setText(b);
			}
		});
