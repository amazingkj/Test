...
public class korea01_02 extends JFrame{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					korea01_02 window = new korea01_02();
	...
	private void initialize() {
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				dto.setMeimg_2("./images/hs_ko1_2.png");
		...
		JLabel btn1_2k = new JLabel("New label");
		btn1_2k.setIcon(new ImageIcon("./images/hs_ko1_2.png"));
		btn1_2k.setBounds(12, 0, 448, 203);
		getContentPane().add(btn1_2k);
		...
		btnNewButton_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				String b=Integer.toString(23400*i);
				textField.setText(b);
			}
		});
