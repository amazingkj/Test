...
public class korea02_01 extends JFrame{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					korea02_01 window = new korea02_01();
	...
	private void initialize() {
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				dto.setMeimg_2("./images/hs_ko2_1.png");
		...
		JLabel btn2_1k = new JLabel("New label");
		btn2_1k.setIcon(new ImageIcon("./images/hs_ko2_1.png"));
		btn2_1k.setBounds(12, 0, 448, 203);
		getContentPane().add(btn2_1k);
