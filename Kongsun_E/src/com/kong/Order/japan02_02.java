...
public class japan02_02 extends JFrame{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					japan02_02 window = new japan02_02();
	...
	private void initialize() {
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				dto.setMeimg_2("./images/hs_jp2_2.png");
		...
		JLabel btn2_2j = new JLabel("New label");
		btn2_2j.setIcon(new ImageIcon("./images/hs_jp2_2.png"));
		btn2_2j.setBounds(12, 0, 448, 203);
		getContentPane().add(btn2_2j);
		...
		btnNewButton_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				String b=Integer.toString(14900*i);
				textField.setText(b);
			}
		});
