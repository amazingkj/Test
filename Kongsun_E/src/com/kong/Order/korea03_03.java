...
public class korea03_03 extends JFrame{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					korea03_03 window = new korea03_03();
	...
	private void initialize() {
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				dto.setMeimg_2("./images/hs_ko3_3.png");
		...
		JLabel btn3_3k = new JLabel("New label");
		btn3_3k.setIcon(new ImageIcon("./images/hs_ko3_3.png"));
		btn3_3k.setBounds(12, 0, 448, 203);
		getContentPane().add(btn3_3k);
		...
		btnNewButton_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				String b=Integer.toString(60000*i);
				textField.setText(b);
			}
		});
