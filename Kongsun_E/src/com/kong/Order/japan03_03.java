...
public class japan03_03 extends JFrame{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					japan03_03 window = new japan03_03();
	...
	private void initialize() {
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				dto.setMeimg_2("./images/hs_jp3_3.png");
		...
		JLabel btn3_3j = new JLabel("New label");
		btn3_3j.setIcon(new ImageIcon("./images/hs_jp3_3.png"));
		btn3_3j.setBounds(12, 0, 448, 203);
		getContentPane().add(btn3_3j);
		...
		btnNewButton_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				String b=Integer.toString(13000*i);
				textField.setText(b);
			}
		});
