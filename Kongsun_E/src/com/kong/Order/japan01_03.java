...
public class japan01_03 extends JFrame{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					japan01_03 window = new japan01_03();
	...
	private void initialize() {
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				dto.setMeimg_2("./images/hs_jp1_3.png");
		...
		JLabel btn1_3j = new JLabel("New label");
		btn1_3j.setIcon(new ImageIcon("./images/hs_jp1_3.png"));
		btn1_3j.setBounds(12, 0, 448, 203);
		getContentPane().add(btn1_3j);
		...
		btnNewButton_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				String b=Integer.toString(10900*i);
				textField.setText(b);
			}
		});
