...
public class china02_01 extends JFrame{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					china02_01 window = new china02_01();
	...
	private void initialize() {
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				dto.setMeimg_2("./images/hs_ch2_1.png");
		...
		JLabel btn2_1c = new JLabel("New label");
		btn2_1c.setIcon(new ImageIcon("./images/hs_ch2_1.png"));
		btn2_1c.setBounds(12, 0, 448, 203);
		getContentPane().add(btn2_1c);
		...
		btnNewButton_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				String b=Integer.toString(7500*i);
				textField.setText(b);
			}
		});
