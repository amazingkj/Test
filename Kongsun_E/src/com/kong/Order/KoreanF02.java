...
import com.kong.Home.A_festaurant;
import com.kong.Home.Home;
import com.kong.Home.My;

public class KoreanF02 extends JFrame{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					KoreanF02 window = new KoreanF02();
	...
	private void initialize() {
		...
		JLabel lblNewLabel = new JLabel("소정이네 죽도령");
		...
		btnNewButton.setIcon(new ImageIcon("./images/hs_ko2_1.png"));
		...
		button.setIcon(new ImageIcon("./images/hs_ko2_2.png"));
		...
		button_1.setIcon(new ImageIcon("./images/hs_ko2_3.png"));
