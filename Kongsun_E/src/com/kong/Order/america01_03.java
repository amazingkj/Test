...
public class america01_03 extends JFrame{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					america01_03 window = new america01_03();
	...
	private void initialize() {
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				dto.setMeimg_2("./images/hs_am1_3.png");
		...
		JLabel btn1_3a = new JLabel("New label");
		btn1_3a.setIcon(new ImageIcon("./images/hs_am1_3.png"));
		btn1_3a.setBounds(12, 0, 448, 203);
		getContentPane().add(btn1_3a);
		...
		btnNewButton_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				String b=Integer.toString(2400*i);
				textField.setText(b);
			}
		});
