...
public class AmericaF02 extends JFrame{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AmericaF02 window = new AmericaF02();
	...
	private void initialize() {
		...
		JLabel lblNewLabel = new JLabel("홀리오");
		...
		btnNewButton.setIcon(new ImageIcon("./images/hs_am2_1.png"));
		...
		button.setIcon(new ImageIcon("./images/hs_am2_2.png"));
		...
		button_1.setIcon(new ImageIcon("./images/hs_am2_3.png"));
