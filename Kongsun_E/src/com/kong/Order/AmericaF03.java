...
import com.kong.Home.D_festaurant;
import com.kong.Home.Home;
import com.kong.Home.My;

public class AmericaF03 extends JFrame{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AmericaF03 window = new AmericaF03();
	...
	private void initialize() {
		...
		JLabel lblNewLabel = new JLabel("제비 파스타&리조또");
		...
		btnNewButton.setIcon(new ImageIcon("./images/hs_am3_1.png"));
		...
		button.setIcon(new ImageIcon("./images/hs_am3_2.png"));
		...
		button_1.setIcon(new ImageIcon("./images/hs_am3_3.png"));
